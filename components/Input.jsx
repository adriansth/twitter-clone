...
export default function Input() {
    return(
        <div className='flex border-b border-gray-200 p-3 space-x-3'>
            <img 
                src="https://media-exp1.licdn.com/dms/image/C5603AQFWV8NNd6QH7A/profile-displayphoto-shrink_800_800/0/1662679020955?e=1668038400&v=beta&t=QWyNI1d_HPnCV2RArX_UBFFLrj7QCj-XMvLNkDPqCyE" 
                alt="user-img" 
